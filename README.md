...
| "Muitas tentativas. Tente novamente em 15 minutos." | Rate limiter de `/login` e `/register` (10 tentativas / 15 min por IP). A troca de senha tem balde próprio (5 / 15 min). | Aguarde 15 min ou reinicie o backend |
